    ...
    local function crownPlayerCondition(descObj)
        if descObj and descObj.ObjType == 5 and descObj.ObjVariant == 100 and descObj.ObjSubType == CHAMPION_CROWN then
            if (descObj.Entity ~= nil) then
                ...
                if EID.holdTabPlayer and (EID.holdTabPlayer:ToPlayer():GetPlayerType() == CHARACTER or EID.holdTabPlayer:ToPlayer():GetPlayerType() == CHARACTER2) then return true end
            end
        end
    end
